        ...
        <CTASection id="About_CTA">
          ...
          <div className="text-gray-700 flex flex-col items-center text-center justify-center gap-8 w-[100%] h-[100%] sm:w-[80%] sm:h-[80%] p-4">
            <p>
              ...
              <span className="font-bold text-black">Banking Acumen</span>, and
              an <span className="font-semibold text-gray-700">Intern</span> at{" "}
              <span className="font-bold text-black">
                The Good People Data Company
              </span>
              , I am actively honing my technical skills and building expertise
              in the dynamic tech landscape. A passionate tech enthusiast with
              an entrepreneurial mindset, I am driven to innovate, solve complex
              problems, and make a lasting impact through my work. My commitment
              to continuous learning and willingness to embrace calculated risks
